...
void	ns_ldi4(t_cursor **cur, t_map *m_map, t_reg reg, unsigned char *str)
{
	t_cursor 	*temp;
...
void	ns_ldi3(t_cursor **cur, t_map *m_map, t_reg reg, unsigned char *str)
{
	t_cursor 	*temp;
...
void	ns_ldi2(t_cursor **cur, t_map *m_map, t_reg reg, unsigned char *str)
{
	t_cursor 	*temp;
